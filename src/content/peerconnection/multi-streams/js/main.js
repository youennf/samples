...
function gotRemoteStream(e) {
  ...
  var videoId = "remoteVideo" + videos.childElementCount;
  div.innerHTML = '<video id="' + videoId + '" controls></video>';
...
*/
  ...
  div.innerHTML = '<video id="' + videoId + '" controls></video>';
  videos.appendChild(div);
  document.getElementById(videoId).srcObject = new MediaStream([remoteStream.getVideoTracks()[0], remoteStream.getAudioTracks()[0]]);
  document.getElementById(videoId).play();
